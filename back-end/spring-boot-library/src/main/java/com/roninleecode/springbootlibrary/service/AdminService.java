...
import com.roninleecode.springbootlibrary.requestmodels.AddBookRequest;
...
public class AdminService {
	...
	public void deleteBook(Long bookId) throws Exception{
		...
		//phải xóa table có chứa foreign key của book trc
		//Lưu ý: * do thiết kế database(project này) ko theo foreign key nên ko cần xóa theo thứ tự

...
export const AddNewBook = () => {
    ...
    async function submitNewBook() {
        ...
        if(authState?.isAuthenticated && title.trim() !== '' && title.trim() !== '' && author.trim() !== ''
            && category.trim() !== '' && description.trim() !== '' && copies >= 0) {
            ...
            const addNewBookResponse = await fetch(url,requestOptions);

            if(!addNewBookResponse.ok){

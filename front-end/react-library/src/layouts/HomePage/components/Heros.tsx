        ...
        <div>
                ...
                <div className="row g-0 mt-5">
                    ...
                    <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
                        <div className="ml-2">
                            ...
                            <p className="lead">
                                The libr  ary team would love to know what you have been reading.
                    ...
                    justify-content-center align-items-center">
                        <div className="ml-2">
                            ...
                            <p className="lead">
                                ...
                                for our Roninlee Read students ! We are diligent about our book selection
            ...
            <div className="d-lg-none">
                <div className="container">
                    <div className="m-2">
                        <div className="col-imge-left"></div>

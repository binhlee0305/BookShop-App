...
export const SearchBooksPage = () => {
    ...
    //Fetch API Search book by Title
    const searchHandler = () => {
        if (search === '') {
            setSearchUrl('');
        } else {
            // vẫn còn bug (page =0 lúc đổi currentPage)
    ...
    const categoryField = (value: string) => {
        if (
            ...
            // vẫn còn bug lúc đổi currentPage, page = 0;
            // setCurrentPage(1); // trả currentPage về trang 1 khi đổi category

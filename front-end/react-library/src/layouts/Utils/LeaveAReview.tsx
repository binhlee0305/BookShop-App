...
export const LeaveAReview: React.FC<{submitReview: any}> = (props) => {
    ...
    const [displayInput, setDispalyInput] = useState(false);
    const [reviewDescription, setReviewDescription] = useState('');
    const starValue = (value: number) => {
        setStarInput(value);
        setDispalyInput(true);
    }
        ...
        <div className="dropdown" style={{ cursor: 'pointer' }}>
            ...
            {displayInput &&
                <form method="POST" action="#">
                    ...
                    <div>
                        <button onClick={submitReviewHandler}type="button" className="btn btn-primary mt-3">Submit review</button>
                    </div>
